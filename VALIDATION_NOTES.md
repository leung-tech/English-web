...
## P1–P6 curriculum coverage extension
The Primary English Studio was audited against the P1–P6 progression supplied for this release. Existing primary materials already covered broad vocabulary, grammar, reading, listening, sentence construction, proofreading, writing planners, P1–P3 games and P4–P6 model-writing support. The new curriculum-coverage layer reinforces the remaining progression points without replacing existing practice: every grade now has 12 targeted vocabulary items, 4 original grammar checks, 3 original reading texts with 2 bilingual four-option questions each, 3 sentence builders, 3 proofreading pairs and 3 additional writing prompts. The reading sequence progresses from picture clues, labels, notices, timetables and sequencing in P1–P3 to diaries, instructions, reports, emails, context clues, formal letters, opinion writing and narrative inference in P4–P6.

A new P1–P6 Writing Skills Studio supplies two original guided writing tasks at each grade, for a total of 12 tasks. Each task provides English-first instructions with immediate Traditional Chinese support, a four-step plan, a visible self-check, an age-appropriate minimum word target and a browser-local draft field. P1–P3 tasks emphasise sentence control and picture-sequence stories; P4–P6 tasks develop email, instruction, report, leaflet, personal-letter and article structures. The studio visibly states that it only confirms a minimum-length self-check, keeps drafts in the current browser and does not provide automated writing-quality scoring, school records, accounts or uploads.

Validation passed with `node --check primary-curriculum-coverage-extension.js`, `node --check app.js`, `node .quality-audit.js`, `node .gemini-pages-audit.js` and `git diff --check`. The primary audit now loads and verifies every new coverage category and the two guided studio tasks per grade. Local browser verification confirmed the P3 Writing Skills Studio displayed a bilingual Four-picture story task with original-practice boundary, four planning steps, visible self-check, 40–50 word target and local draft field; a 40+ word draft returned “Writing draft recorded.” without a language-quality score. A validation defect in which the studio self-check was mistakenly handled as a checkbox task was corrected and retested. The P6 standard reading session also loaded the new original “A Formal Letter: Safer Crossings” with a bilingual purpose question and four answer options.

Public GitHub Pages verification succeeded after workflow `32622693852` completed for commit `f93a24a`. The cache-busted public P3 Write route displayed the new Writing Skills Studio beside Sentence builder, Proofreading and Writing planner. The studio selected a two-task module, and the public “A helpful diary” task showed English-first instructions with Traditional Chinese support, original-practice notice, clear no-automatic-writing-quality-score boundary, four planning steps, visible self-check, 40–50 word target and browser-local draft field. The published flow contains no account, upload, official marking or score prediction.

## P5–P6 grammar and S1 Interview readiness
The Primary English Studio now includes 23 additional original P5–P6 contextual grammar checks: 12 for P5 and 11 for P6. The P5 set practises present-perfect use with *already*, *yet*, *ever*, *for* and *since*, finished-time contrast, *although*, first conditional, relative clauses, indirect questions, infinitive patterns and result connectors. The P6 set extends present-perfect control and finished-time contrast with past-continuous/simple-past sequencing, passive voice, second conditional, reported speech, gerunds, relative clauses and formal contrast connectors. Each item has four choices, English-first directions, immediate Traditional Chinese support, a hint and bilingual explanation.

A new P5–P6 S1 Interview practice module has six original tasks at each grade. Each grade receives two replayable interview-listening scripts with two objective checks each and two personal-response tasks. P5 focuses on self-introduction, a meaningful activity and useful questions for a new school; P6 focuses on responsibility, challenges, transition planning and contribution to school life. The speaking tasks show timing, four bilingual response frames, a model replay button, useful language and a browser-local completion self-check. They explicitly provide no automatic judgement of accent, fluency, spoken-language quality, interview suitability, school placement or outcome.

Public endpoint checks completed before implementation: the Primary endpoint `https://leung-tech.github.io/English-web/`, Secondary endpoint `https://leung-tech.github.io/English-web/secondary/` and Senior endpoint `https://leung-tech.github.io/English-web/senior/` all loaded successfully. Local validation passed with `node --check p5-p6-s1-interview-extension.js`, `node --check app.js`, `node .quality-audit.js` and `git diff --check`. The quality audit confirmed 23 added grammar checks and eight S1 Interview listening/speaking task records across P5 and P6. Browser verification confirmed the P5 S1 Interview module displayed six tasks; a correct listening response showed bilingual feedback and transcript after checking. P5 Grammar & patterns listed 26 questions and loaded the new completed-time contrast question. P6 displayed the S1 Interview speaking task with four planning frames and, after self-check confirmation, a clear no-accent/no-fluency/no-interview-suitability-score boundary.

Public GitHub Pages verification succeeded after workflow `32623605047` completed for commit `92f6755`. The cache-busted public P5 Listen & Speak route displayed the new S1 Interview practice module as a six-item activity. Its published “S1 interview: a meaningful activity” task showed the original interview prompt, immediate Traditional Chinese support, 30-second preparation and 45–60-second speaking guidance, four response frames, model replay, useful language and a browser-local completion self-check. The public task visibly uses guided self-review and provides no automatic accent, fluency, spoken-language-quality, interview-suitability or school-placement/outcome judgement.

## P1–P4 grammar focus and S1–S3 advanced reading/writing
The Primary English Studio now includes 32 additional original interactive grammar checks across P1–P4, with eight contextual four-option questions per year. P1 reinforces subject pronouns, *has*, articles, plural nouns, *can*, location prepositions and question punctuation. P2 adds *do/does*, negatives, countable and uncountable nouns, *some/any*, *there is/are*, frequency adverbs and time/place prepositions. P3 adds regular and irregular past forms, *will* and *be going to*, comparatives/superlatives, conjunctions, object pronouns and first conditional structure. P4 adds present-perfect form awareness, finished-past-time contrast, *must/should*, longer-adjective comparison, *although*, time prepositions and short *who* relative clauses. The combined coverage-extension grammar bank now has at least twelve checks at each of P1–P4, in addition to the wider established practice bank.

The Secondary English Studio now extends the S1, S2 and S3 curriculum reading strategy labs to 28 original bilingual objective items per stage, and each curriculum writing bank now contains three original advanced scaffolds. The new S1 source pair practises purpose, cross-source viewpoint, inference and balanced rules for a shared study space. The S2 source pair develops finding-versus-limit reasoning, feasibility, cautious tone and a reviewable later-library-opening proposal. The S3 three-source set develops evidence relevance, scope limits, agreement, caveat, implicit position, tone and qualified conclusions for a community transport trial. Each related advanced writing task includes a source pack, four-part paragraph map, language bank, original model, browser-local draft area and completion-only self-check. The materials explicitly remain original practice rather than official examination scripts, marking exemplars or automatic writing-quality scoring.

Validation passed with `node --check p1-p4-grammar-focus-extension.js`, `node --check s1-s3-advanced-reading-writing-extension.js`, `node .quality-audit.js`, `node secondary-s1-s3-audit.js`, `node secondary-curriculum-alignment-audit.js`, `node .gemini-pages-audit.js` and `git diff --check`. The updated primary audit requires the new P1–P4 data file and eight valid bilingual focus questions per year. The updated secondary audits load the new extension, require 28 reading items and three advanced writing scaffolds per stage, and validate reading/writing object completeness.

Local browser verification confirmed the cache-busted P1 Apply → Grammar & patterns flow displayed an eight-question session and returned bilingual immediate feedback for “The boy is running now.”; local completion advanced from 24 to 25. P4 Grammar & patterns likewise displayed an eight-question session, beginning with the planned-future/singular-group item “Our class is going to make a poster.” In the Secondary Studio, S1 EXTEND’s Reading strategy lab displayed `1 / 28`, and Narrative & description scaffold displayed `1 / 3` with bilingual task wording, source choices, four planning sections, language bank, original model, local draft field and a visible no-automatic-writing-quality-score boundary. The S1–S3 data audit also confirmed the 28-reading/3-writing totals and new task identifiers `s1-arw-w03`, `s2-arw-w03` and `s3-arw-w03`.

Public GitHub Pages verification succeeded after workflow `32625229481` completed for commit `da65e46`. The cache-busted Primary endpoint displayed P1 Apply → Grammar & patterns as a 22-question combined bank and opened an eight-question grammar-focus session; a published item tested “The two cats are small.” with four options. The cache-busted Secondary endpoint loaded the advanced reading/writing extension. In S3 READY, Critical reading strategy lab visibly displayed `1 / 28` and a bilingual paired-source reading item on later library access, while retaining the original-practice and non-official-HKDSE boundary. The public build therefore contains the P1–P4 grammar expansion and S1–S3 advanced reading/writing data, not only their local development versions.
