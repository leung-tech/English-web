(() => {
  ...
  function bindNavEvents() {
    ...
    $('#clear-progress').onclick = () => { localStorage.removeItem(progressKey); localStorage.removeItem(draftKey); resetTask(); render(); };
  }
