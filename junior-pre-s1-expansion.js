...
(() => {
  ...
  window.PRE_S1_ENGLISH_MOCK = {
    ...
    questions: [
      ...
      {
        id: 'extended-read-main-idea', section: 'Section D · Extended reading', sectionZh: '丁部 · 進階閱讀理解', route: 'read',
        passage: { title: 'Magazine article · A place to pause', text: 'At the start of this term, P6 pupils at Harbour View School noticed that some classmates found the playground too busy during lunchtime. The Student Council did not want to stop active games, so it asked pupils what else they would like to do. Many suggested a calm place to read, draw or talk quietly with a friend.\n\nThe school then turned one unused corridor corner into the Pause Point. Volunteers added floor cushions, a small book shelf and a notice board for short puzzles. To make the space fair, pupils may use it for fifteen minutes at a time and should return the materials they borrow. After a month, the council collected comments again. Most pupils said that the Pause Point gave them another choice at lunch, while sports teams were still able to use the playground as usual. The council is now considering a second corner near the library.' },
        prompt: 'What is the main purpose of the Pause Point?', promptZh: 'Pause Point 的主要目的為何？', options: ['To give pupils a quiet lunchtime choice', 'To replace the playground for sports teams', 'To store all school books', 'To sell puzzles to pupils'], answer: 0,
        explanation: 'The article explains that the Pause Point gives pupils a calm place to read, draw or talk while the playground remains available for games.', explanationZh: '文章說 Pause Point 讓學生在午飯時間有安靜的選擇，而操場仍可進行活動。', hint: 'Read the first paragraph and the final survey result to identify the central purpose. 閱讀第一段及最後的調查結果，找出主要目的。'
      },
      {
        id: 'extended-read-reference', section: 'Section D · Extended reading', sectionZh: '丁部 · 進階閱讀理解', route: 'read',
        passage: { title: 'Magazine article · A place to pause', text: 'At the start of this term, P6 pupils at Harbour View School noticed that some classmates found the playground too busy during lunchtime. The Student Council did not want to stop active games, so it asked pupils what else they would like to do. Many suggested a calm place to read, draw or talk quietly with a friend.\n\nThe school then turned one unused corridor corner into the Pause Point. Volunteers added floor cushions, a small book shelf and a notice board for short puzzles. To make the space fair, pupils may use it for fifteen minutes at a time and should return the materials they borrow. After a month, the council collected comments again. Most pupils said that the Pause Point gave them another choice at lunch, while sports teams were still able to use the playground as usual. The council is now considering a second corner near the library.' },
        prompt: 'In “return the materials they borrow”, what does “they” refer to?', promptZh: '在「return the materials they borrow」中，they 指的是誰？', options: ['Pupils using the Pause Point', 'The school volunteers', 'Sports teams only', 'The library workers'], answer: 0,
        explanation: 'The sentence before it says that pupils may use the space, so they refers to the pupils who use the Pause Point.', explanationZh: '前一句說學生可以使用該空間，因此 they 指使用 Pause Point 的學生。', hint: 'Look at the noun named just before the pronoun. 留意代名詞前剛出現的名詞。'
      },
      {
        id: 'extended-read-inference', section: 'Section D · Extended reading', sectionZh: '丁部 · 進階閱讀理解', route: 'read',
        passage: { title: 'Magazine article · A place to pause', text: 'At the start of this term, P6 pupils at Harbour View School noticed that some classmates found the playground too busy during lunchtime. The Student Council did not want to stop active games, so it asked pupils what else they would like to do. Many suggested a calm place to read, draw or talk quietly with a friend.\n\nThe school then turned one unused corridor corner into the Pause Point. Volunteers added floor cushions, a small book shelf and a notice board for short puzzles. To make the space fair, pupils may use it for fifteen minutes at a time and should return the materials they borrow. After a month, the council collected comments again. Most pupils said that the Pause Point gave them another choice at lunch, while sports teams were still able to use the playground as usual. The council is now considering a second corner near the library.' },
        prompt: 'Why is the council considering a second Pause Point?', promptZh: '學生會為甚麼考慮設置第二個 Pause Point？', options: ['The first one appears to be useful and popular.', 'The playground has closed permanently.', 'Pupils no longer want to read.', 'The corridor corner is too noisy for sport.'], answer: 0,
        explanation: 'The council collected positive comments, and most pupils said the first Pause Point gave them another useful choice at lunch.', explanationZh: '學生會收到正面意見，多數學生認為第一個 Pause Point 在午飯時間提供了有用的選擇。', hint: 'Infer from the positive comments and the next planned action. 從正面評價及下一步計劃作推論。'
      },
      {
        id: 'extended-read-writer-choice', section: 'Section D · Extended reading', sectionZh: '丁部 · 進階閱讀理解', route: 'read',
        passage: { title: 'Magazine article · A place to pause', text: 'At the start of this term, P6 pupils at Harbour View School noticed that some classmates found the playground too busy during lunchtime. The Student Council did not want to stop active games, so it asked pupils what else they would like to do. Many suggested a calm place to read, draw or talk quietly with a friend.\n\nThe school then turned one unused corridor corner into the Pause Point. Volunteers added floor cushions, a small book shelf and a notice board for short puzzles. To make the space fair, pupils may use it for fifteen minutes at a time and should return the materials they borrow. After a month, the council collected comments again. Most pupils said that the Pause Point gave them another choice at lunch, while sports teams were still able to use the playground as usual. The council is now considering a second corner near the library.' },
        prompt: 'Why does the writer mention that sports teams can still use the playground?', promptZh: '作者為甚麼提及運動隊仍可使用操場？', options: ['To show that the new space supports different pupil needs', 'To explain how to join a sports team', 'To prove that the Pause Point is only for athletes', 'To describe a new PE lesson'], answer: 0,
        explanation: 'The detail shows a balanced solution: quiet activities are added without taking away active play.', explanationZh: '這項資料顯示方案兼顧不同需要：加入安靜活動，同時不影響運動。', hint: 'Ask how this detail supports the article’s message about choice. 思考這個細節如何支持「選擇」的主旨。'
      },
      {
        id: 'cloze-manage', section: 'Section E · Integrated cloze', sectionZh: '戊部 · 綜合填空', route: 'language',
        ...
        prompt: 'Choose the best word for blank (1).', promptZh: '選出填空 (1) 的最佳答案。', options: ['manage', 'manager', 'managed', 'managing'], answer: 0,
        explanation: 'After “wanted to”, use the base form of the verb: manage.', explanationZh: 'wanted to 後要用動詞原形：manage。', hint: 'After to, check for the base verb. to 後要找動詞原形。'
      },
      {
        id: 'cloze-plans', section: 'Section E · Integrated cloze', sectionZh: '戊部 · 綜合填空', route: 'language',
        passage: { title: 'Integrated cloze · First month at secondary school', text: 'When Alia began secondary school, she wanted to (1) ______ her time well. Every Sunday, she (2) ______ the week ahead. On the planner, she writes homework (3) ______ the day it is given, then adds a small star next to tasks that need (4) ______ before Friday. She also puts her PE kit by the door (5) ______ she will not forget it. After two weeks, Alia has already (6) ______ that short planning time makes busy mornings calmer.' },
        prompt: 'Choose the best word for blank (2).', promptZh: '選出填空 (2) 的最佳答案。', options: ['plans', 'plan', 'planning', 'planned'], answer: 0,
        explanation: 'Every Sunday shows a regular action. The subject she takes the present-tense form plans.', explanationZh: 'Every Sunday 表示習慣動作；主語 she 配簡單現在式 plans。', hint: 'Find the subject and the routine time clue. 找出主語和表示習慣的時間提示。'
      },
      {
        id: 'cloze-on', section: 'Section E · Integrated cloze', sectionZh: '戊部 · 綜合填空', route: 'language',
        passage: { title: 'Integrated cloze · First month at secondary school', text: 'When Alia began secondary school, she wanted to (1) ______ her time well. Every Sunday, she (2) ______ the week ahead. On the planner, she writes homework (3) ______ the day it is given, then adds a small star next to tasks that need (4) ______ before Friday. She also puts her PE kit by the door (5) ______ she will not forget it. After two weeks, Alia has already (6) ______ that short planning time makes busy mornings calmer.' },
        prompt: 'Choose the best word for blank (3).', promptZh: '選出填空 (3) 的最佳答案。', options: ['on', 'at', 'in', 'by'], answer: 0,
        explanation: 'Use on with a day: on the day it is given.', explanationZh: '表示某一天要用 on：on the day it is given。', hint: 'This blank comes before a day. 這個空格後面是 day。'
      },
      {
      ...
      {
        id: 'cloze-so', section: 'Section E · Integrated cloze', sectionZh: '戊部 · 綜合填空', route: 'language',
        passage: { title: 'Integrated cloze · First month at secondary school', text: 'When Alia began secondary school, she wanted to (1) ______ her time well. Every Sunday, she (2) ______ the week ahead. On the planner, she writes homework (3) ______ the day it is given, then adds a small star next to tasks that need (4) ______ before Friday. She also puts her PE kit by the door (5) ______ she will not forget it. After two weeks, Alia has already (6) ______ that short planning time makes busy mornings calmer.' },
        prompt: 'Choose the best word for blank (5).', promptZh: '選出填空 (5) 的最佳答案。', options: ['so', 'although', 'but', 'because'], answer: 0,
        explanation: 'The second part gives the result of putting the PE kit by the door, so is the best linker.', explanationZh: '後半句是把體育服放在門邊的結果，因此 so 最合適。', hint: 'Decide whether the second idea is a result or a contrast. 判斷第二個意思是結果還是轉折。'
      },
      {
        id: 'cloze-noticed', section: 'Section E · Integrated cloze', sectionZh: '戊部 · 綜合填空', route: 'language',
        passage: { title: 'Integrated cloze · First month at secondary school', text: 'When Alia began secondary school, she wanted to (1) ______ her time well. Every Sunday, she (2) ______ the week ahead. On the planner, she writes homework (3) ______ the day it is given, then adds a small star next to tasks that need (4) ______ before Friday. She also puts her PE kit by the door (5) ______ she will not forget it. After two weeks, Alia has already (6) ______ that short planning time makes busy mornings calmer.' },
        prompt: 'Choose the best word for blank (6).', promptZh: '選出填空 (6) 的最佳答案。', options: ['noticed', 'notice', 'notices', 'noticing'], answer: 0,
        explanation: 'After has already, use the past participle. Noticed is the correct form.', explanationZh: 'has already 後要用過去分詞；noticed 是正確形式。', hint: 'Look at the words has already before the blank. 留意空格前的 has already。'
      },
      {
        id: 'writing-welcome-day', section: 'Section F · Writing', sectionZh: '己部 · 寫作', route: 'write',
