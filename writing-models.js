...
window.WRITING_ERROR_QUIZZES = {
  'p4-green-day': [
    { bad: 'Our school hold a Green Day this Friday.', prompt: 'Choose the best correction for the planned event.', promptZh: '為將舉行的活動選出最佳改正句。', options: ['Our school holds a Green Day this Friday.', 'Our school will hold a Green Day this Friday.', 'Our school holding a Green Day this Friday.'], answer: 1, explanation: 'Use will + base verb for a planned future event.', explanationZh: '將舉行的活動可用 will + 原形動詞。' },
    { bad: 'I invite you join our Green Day.', prompt: 'Choose the friendliest and grammatically correct invitation.', promptZh: '選出最友善而文法正確的邀請句。', options: ['I would love you to join our Green Day.', 'I would love you join our Green Day.', 'I would loving you to join our Green Day.'], answer: 0, explanation: 'Use would love someone to + base verb.', explanationZh: '使用 would love someone to + 原形動詞。' },
    { bad: 'Please bring a reusable bottle because help school.', prompt: 'Choose the complete reason.', promptZh: '選出完整的理由句。', options: ['Please bring a reusable bottle because help our school.', 'Please bring a reusable bottle because it helps our school.', 'Please bring a reusable bottle because it helping our school.'], answer: 1, explanation: 'A reason clause needs a subject and a verb.', explanationZh: '理由子句必須有主語和動詞。' }
  ],
  'p4-wallet': [
    { bad: 'Ben find a wallet beside the bus stop.', prompt: 'Choose the correct story tense.', promptZh: '選出正確的故事時態。', options: ['Ben finds a wallet beside the bus stop.', 'Ben found a wallet beside the bus stop.', 'Ben finding a wallet beside the bus stop.'], answer: 1, explanation: 'A finished story event uses simple past.', explanationZh: '完成的故事事件使用簡單過去式。' },
    { bad: 'Ben walked home when he see the wallet.', prompt: 'Choose the best background-and-event sentence.', promptZh: '選出最合適的背景與事件句子。', options: ['Ben was walking home when he saw the wallet.', 'Ben walking home when he saw the wallet.', 'Ben was walk home when he saw the wallet.'], answer: 0, explanation: 'Use past continuous for background action and simple past for a sudden event.', explanationZh: '背景動作用過去進行式，突發事件用簡單過去式。' },
    { bad: 'Ben felt pride because he did the right thing.', prompt: 'Choose the correct feeling word.', promptZh: '選出正確的感受詞。', options: ['Ben felt proudly because he did the right thing.', 'Ben felt proud because he did the right thing.', 'Ben felt pride because he did the right thing.'], answer: 1, explanation: 'Use the adjective proud after felt.', explanationZh: 'felt 後要用形容詞 proud。' }
  ],
  'p5-canteen': [
    { bad: 'Hi Principal, our canteen is bad.', prompt: 'Choose the strongest formal email opening.', promptZh: '選出最合適的正式電郵開首。', options: ['Dear Principal Chan, I am writing to suggest two improvements to the school canteen.', 'Hi Principal, our canteen is very bad.', 'Hello, I want the canteen better.'], answer: 0, explanation: 'A formal email needs a respectful greeting and a clear purpose.', explanationZh: '正式電郵需要禮貌稱呼和清楚目的。' },
    { bad: 'The canteen could sells a fruit cup.', prompt: 'Choose the correct modal-verb sentence.', promptZh: '選出正確的情態動詞句子。', options: ['The canteen could selling a fruit cup.', 'The canteen could sell a fruit cup.', 'The canteen could sells a fruit cup.'], answer: 1, explanation: 'A modal verb is followed by a base verb.', explanationZh: '情態動詞後面要接原形動詞。' },
    { bad: 'If pupils bring reusable cups, fewer plastic cups will be thrown away.', prompt: 'Choose the correct likely-future conditional.', promptZh: '選出正確的將來可能條件句。', options: ['If pupils will bring reusable cups, fewer plastic cups will be thrown away.', 'If pupils bring reusable cups, fewer plastic cups will be thrown away.', 'If pupils brought reusable cups, fewer plastic cups are thrown away.'], answer: 1, explanation: 'Use present tense after if and will in the result clause.', explanationZh: 'if 後用現在式，結果子句用 will。' }
  ],
  'p5-rainy-helper': [
    { bad: 'Heavy rain fell when Mia leave the library.', prompt: 'Choose the best setting sentence.', promptZh: '選出最好的故事場景句。', options: ['Heavy rain was falling when Mia left the library.', 'Heavy rain is falling when Mia left the library.', 'Heavy rain was fall when Mia left the library.'], answer: 0, explanation: 'Use was/were + verb-ing for background action and simple past for the event.', explanationZh: '背景動作用 was/were + -ing，事件用簡單過去式。' },
    { bad: 'Mia open her umbrella and pick up the sheets.', prompt: 'Choose the correct completed actions.', promptZh: '選出正確的完成動作句。', options: ['Mia opened her umbrella and picked up the sheets.', 'Mia opens her umbrella and picked up the sheets.', 'Mia opened her umbrella and pick up the sheets.'], answer: 0, explanation: 'Keep finished actions in simple past.', explanationZh: '完成的動作要保持簡單過去式。' },
    { bad: 'Although Mia missed the bus, but she smiled.', prompt: 'Choose the correct contrast sentence.', promptZh: '選出正確的轉折句。', options: ['Although Mia missed the bus, but she smiled.', 'Although Mia missed the bus, she smiled.', 'Although Mia missed the bus, so she smiled.'], answer: 1, explanation: 'Do not use but or so after although.', explanationZh: 'although 後不可再用 but 或 so。' }
  ],
  'p6-study-corner': [
    { bad: 'I propose make a quiet study corner.', prompt: 'Choose the formal proposal opening.', promptZh: '選出正式建議書開首。', options: ['I am writing to propose a quiet study corner in the library.', 'I propose make a quiet study corner.', 'I am writing propose making a quiet study corner.'], answer: 0, explanation: 'A formal proposal opening states the purpose and the location precisely.', explanationZh: '正式建議書開首要清楚交代目的和地點。' },
    { bad: 'Two tables could placed near the windows.', prompt: 'Choose the correct modal passive form.', promptZh: '選出正確的情態被動語態。', options: ['Two tables could be placed near the windows.', 'Two tables could placed near the windows.', 'Two tables could be placing near the windows.'], answer: 0, explanation: 'Modal passive form: could be + past participle.', explanationZh: '情態被動語態：could be + 過去分詞。' },
    { bad: 'If the project successful, it may encourage pupils.', prompt: 'Choose the complete condition clause.', promptZh: '選出完整的條件子句。', options: ['If the project successful, it may encourage pupils.', 'If the project is successful, it may encourage pupils.', 'If the project be successful, it may encourage pupils.'], answer: 1, explanation: 'A condition clause needs a complete verb phrase: is successful.', explanationZh: '條件子句需要完整動詞片語：is successful。' }
  ],
  'p6-volunteer': [
    { bad: 'Volunteer service are important.', prompt: 'Choose the correct subject–verb agreement.', promptZh: '選出正確的主謂一致句子。', options: ['Volunteer service are important.', 'Volunteer service is important.', 'Volunteer services is important.'], answer: 1, explanation: 'Volunteer service is a singular idea, so use is.', explanationZh: 'Volunteer service 是單數概念，所以用 is。' },
    { bad: 'Pupils can to read stories to children.', prompt: 'Choose the correct sentence after can.', promptZh: '選出 can 後正確的句子。', options: ['Pupils can reading stories to children.', 'Pupils can to read stories to children.', 'Pupils can read stories to children.'], answer: 2, explanation: 'Use a base verb after can.', explanationZh: 'can 後要用原形動詞。' },
    { bad: 'Although some pupils are busy, but one morning can be meaningful.', prompt: 'Choose the correct linker use.', promptZh: '選出正確的連接詞用法。', options: ['Although some pupils are busy, one morning can be meaningful.', 'Although some pupils are busy, but one morning can be meaningful.', 'Although some pupils are busy, so one morning can be meaningful.'], answer: 0, explanation: 'Although already expresses contrast, so do not add but.', explanationZh: 'although 已表達轉折，因此不需再加 but。' }
  ]
};
