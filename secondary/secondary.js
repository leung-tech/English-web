(() => {
  ...
  const moduleRegistry = [
    ...
    { id:'s1-precision-language', stage:'s1-extend', route:'language', symbol:'CP', title:'Language use: coherence & precision', zh:'語言運用：連貫與準確', kind:'grammar', source:'S1_S3_PRECISION_LANGUAGE_2026', bank:'s1Grammar', filterType:'grammar' },
    { id:'s1-reading-reasoning', stage:'s1-extend', route:'read', symbol:'RR', title:'Reading reasoning: detail & inference', zh:'閱讀推理：細節與推論', kind:'reading', source:'S1_S3_READING_REASONING_2026', bank:'s1Reading', filterType:'reading', progressSession:true },
    { id:'s1-contextual-cloze', stage:'s1-extend', route:'read', symbol:'CC', title:'Contextual cloze: links & time', zh:'語境克漏字：連接與時態', kind:'reading', source:'S1_S3_CONTEXTUAL_CLOZE_2026', bank:'s1Cloze', filterType:'cloze', progressSession:true },
    ...
    { id:'s2-precision-language', stage:'s2-consolidate', route:'language', symbol:'CP', title:'Language use: coherence & precision', zh:'語言運用：連貫與準確', kind:'grammar', source:'S1_S3_PRECISION_LANGUAGE_2026', bank:'s2Grammar', filterType:'grammar' },
    { id:'s2-reading-reasoning', stage:'s2-consolidate', route:'read', symbol:'RR', title:'Reading reasoning: idea & evidence', zh:'閱讀推理：主旨與證據', kind:'reading', source:'S1_S3_READING_REASONING_2026', bank:'s2Reading', filterType:'reading', progressSession:true },
    { id:'s2-contextual-cloze', stage:'s2-consolidate', route:'read', symbol:'CC', title:'Contextual cloze: evidence & phrases', zh:'語境克漏字：證據與片語', kind:'reading', source:'S1_S3_CONTEXTUAL_CLOZE_2026', bank:'s2Cloze', filterType:'cloze', progressSession:true },
    ...
    { id:'s3-precision-language', stage:'s3-ready', route:'language', symbol:'CP', title:'Language use: coherence & precision', zh:'語言運用：連貫與準確', kind:'grammar', source:'S1_S3_PRECISION_LANGUAGE_2026', bank:'s3Grammar', filterType:'grammar' },
    { id:'s3-reading-reasoning', stage:'s3-ready', route:'read', symbol:'RR', title:'Reading reasoning: sources & limits', zh:'閱讀推理：來源與限制', kind:'reading', source:'S1_S3_READING_REASONING_2026', bank:'s3Reading', filterType:'reading', progressSession:true },
    { id:'s3-contextual-cloze', stage:'s3-ready', route:'read', symbol:'CC', title:'Contextual cloze: evidence & clauses', zh:'語境克漏字：證據與子句', kind:'reading', source:'S1_S3_CONTEXTUAL_CLOZE_2026', bank:'s3Cloze', filterType:'cloze', progressSession:true },
